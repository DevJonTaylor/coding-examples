 ...
 * {SECURE}     -> http/https
 * {BASE}       -> sub(www/api/accounts)/domain(google/twitter/apple)/top level(com/net/org) www.google.com
...
trait BuildUrlTrait
{
     ...
     *
     * @param array|string|integer $uris is run through url encode function before added.
